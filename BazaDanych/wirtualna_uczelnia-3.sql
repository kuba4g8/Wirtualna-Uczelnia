...
--
-- Host: 127.0.0.1
-- Generation Time: Maj 06, 2025 at 08:20 AM
...
INSERT INTO `grupy` (`id_grupy`, `id_kierunku`, `typ_grupy`) VALUES
(1, 1, 'Laboratoryjna');
...
INSERT INTO `kierunki` (`id_kierunku`, `id_opiekunaRoku`, `wydzial`, `semestr`, `nazwa_kierunku`, `specjalizacja`) VALUES
(1, 17, 'Wydział Elektryczny', 2, 'Informatyka', 'Inżynieria Oprogramowania');
...
INSERT INTO `plan_lekcji` (`id_przedmiotu`, `id_prowadzacego`, `id_grupy`, `id_kierunku`, `sala`, `dzien`, `godzina_startu`, `godzina_konca`, `przedmiot`, `rodzaj`, `notatki`) VALUES
(13, 6, 1, 1, 'D001', '2025-05-05', '12:00:00', '13:30:00', 'Języki Programowania', 'Laboratorium', ''),
(14, 6, 1, 1, 'A301', '2025-05-06', '09:00:00', '10:30:00', 'Bazy Danych', 'Wykład', ''),
(15, 6, 1, 1, 'A301', '2025-05-06', '11:00:00', '12:30:00', 'Bazy Danych', 'Laboratorium', ''),
(16, 6, 1, 1, 'F110', '2025-05-06', '13:00:00', '14:30:00', 'Sieci Komputerowe', 'Wykład', ''),
(17, 6, 1, 1, 'E105', '2025-05-07', '08:00:00', '09:30:00', 'Architektura Komputerów', 'Wykład', ''),
(18, 6, 1, 1, 'E107', '2025-05-07', '10:00:00', '11:30:00', 'Architektura Komputerów', 'Ćwiczenia', ''),
(19, 6, 1, 1, 'C202', '2025-05-08', '09:00:00', '10:30:00', 'Programowanie Obiektowe', 'Laboratorium', ''),
(20, 6, 1, 1, 'C202', '2025-05-08', '11:00:00', '12:30:00', 'Programowanie Obiektowe', 'Ćwiczenia', ''),
(21, 6, 1, 1, 'H005', '2025-05-09', '08:00:00', '09:30:00', 'Grafika Komputerowa', 'Wykład', ''),
(22, 6, 1, 1, 'H005', '2025-05-09', '10:00:00', '11:30:00', 'Grafika Komputerowa', 'Laboratorium', '');
...
(17, 'imie', 'nazwisko', 'stanowisko', 'stopein naukowy');
...
--
ALTER TABLE `grupy`
  MODIFY `id_grupy` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `plan_lekcji`
  MODIFY `id_przedmiotu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
